        ...
        {sampleProducts
          ...
          .map((p, i) => (
            ...
            >
              ...
              <button className="bg-black text-white w-full py-3 rounded-full mt-4">
                Buy Now
              </button>
              <button className="border w-full py-3 rounded-full mt-2 flex justify-center items-center gap-2">
